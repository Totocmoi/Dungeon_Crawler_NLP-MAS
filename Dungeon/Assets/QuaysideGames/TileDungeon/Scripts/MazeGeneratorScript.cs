        ...
        foreach (Node n in NodeInfoMap)
        {
            ...
            if (n.walkable == true)
            {
                ...
                if (n.tileType == "tile_straight")
                {
                    ...
                    {
                        GameObject newDividerDoor = dividerDoor;
                ...
                if (n.isLoop == true && n.hasDivider == true)
                {
                    if (n.tileRotation == 0)
                    {
                        GameObject newDividerArch =dividerArch;
                    ...
                    {
                        GameObject newDividerWindows = dividerWindows;
                ...
                GameObject newObject = n.tilePrefab;
